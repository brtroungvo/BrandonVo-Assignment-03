...
public class BMI_CSC215_Master_BrandonVo {
    ...
    public static void pickVersion(){
        ...
        String versionInput = scan.nextLine();
        String version = fixString(versionInput);

        while (!version.equals("english") && !version.equals("metric") && !version.equals("!")) {
            System.out.print("Please enter the version you want to try: ");
    ...
    public static String fixString(String version){
        version = version.toLowerCase();
        version = version.replaceAll("\\s+","");
        version = version.replaceAll("(\\w)\\1+", "$1");
        return version;
    }
}
...
class EnglishBMI {
    public static void main(String[] args){
        ...
        // Height
        int height = getHeight(scan, name);
